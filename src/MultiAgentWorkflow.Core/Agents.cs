...
public sealed class PlannerAgent : IWorkflowAgent
{
...
public sealed class ResearchAgent : IWorkflowAgent
{
...
public sealed class ExecutorAgent : IWorkflowAgent
{
...
public sealed class ReviewerAgent : IWorkflowAgent
{
